<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('admin.deliveries.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.deliveries.*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <a href="<?php echo e(route('home')); ?>" class="nav-link">View Site</a>
    </div>
</aside>
...
</style><?php /**PATH C:\Users\Sean\OneDrive\Desktop\ground_ecom\ground_ecom\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>