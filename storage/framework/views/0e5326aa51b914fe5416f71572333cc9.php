<?php $__env->startSection('title', 'Checkout - Grace & Ground'); ?>
                ...
                <div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shipping_name" class="form-input" value="<?php echo e(auth()->user()->name ?? ''); ?>" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Phone Number *</label>
                            <input type="text" name="shipping_phone" class="form-input" value="<?php echo e(auth()->user()->phone ?? ''); ?>" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Shipping Address *</label>
                            <textarea name="shipping_address" class="form-input" rows="3" required><?php echo e(auth()->user()->address ?? ''); ?></textarea>
                        </div>
...
<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sean\OneDrive\Desktop\ground_ecom\ground_ecom\resources\views/frontend/checkout/index.blade.php ENDPATH**/ ?>